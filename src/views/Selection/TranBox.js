          ...
          {isExt && (
            <IconButton
              ...
              sx={{
                ...baseBtnStyle,
                "&:hover": {
                  backgroundColor: theme.palette.primary.light + "20", // 添加透明度
          ...
          <DraggableResizable
            ...
            header={
              <Header
                ...
                setSimpleStyle={props.setSimpleStyle}
                hideClickAway={props.hideClickAway}
                setHideClickAway={props.setHideClickAway}
                followSelection={props.followSelection}
                setFollowSelection={props.setFollowSelection}
